...
customElements.define('action-handler-circle-sensor', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-circle-sensor')) {
    return body.querySelector('action-handler-circle-sensor') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-circle-sensor');
